    ...
    return (
        <div
            className={cn(
                ...
                selected ? "border-sky-500 shadow-md ring-2 ring-sky-100 dark:ring-sky-900/50" : isInvalid ? "border-rose-500 shadow-md ring-2 ring-rose-100 dark:ring-rose-900/50" : "border-slate-200 dark:border-slate-700"
            )}
        >
            {/* Node Header */}
            <div
